            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('laporan.store') }}">
                        ...
                        <div>
                            <x-input-label for="tanggal_laporan" :value="__('tanggal_laporan')" />
                            <x-text-input id="tanggal_laporan" class="block mt-1 w-full" type="text" name="tanggal_laporan" :value="old('tanggal_laporan')" required autofocus autocomplete="tanggal_laporan" />
